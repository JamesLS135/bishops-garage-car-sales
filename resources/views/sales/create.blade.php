                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                             ...
                             <div class="md:col-span-2">
                                ...
                                <textarea id="warranty_details" name="warranty_details" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('warranty_details') }}</textarea>
                            </div>
                        </div>

                        <!-- Part-Exchange Section -->
                        <div class="mt-6 border-t pt-6">
                             <h3 class="text-lg font-medium text-gray-900 mb-4">Part-Exchange (Optional)</h3>
                             <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <x-input-label for="part_exchange_car_id" :value="__('Part-Exchange Vehicle')" />
                                    <select name="part_exchange_car_id" id="part_exchange_car_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
