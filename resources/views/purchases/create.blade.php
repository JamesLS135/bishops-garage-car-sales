<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- CORRECTED: Validation error styling --}}
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('purchases.store', $car->id) }}">
                        ...
                        <div id="import-fields" class="mt-6 border-t dark:border-gray-700 pt-6 border-dashed hidden">
    ...
    <script>
        ...
        // Run on page load in case of validation errors to show fields if already checked
